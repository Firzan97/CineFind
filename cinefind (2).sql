...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2019 at 08:25 AM
...
CREATE TABLE `booking` (
  ...
  `totalprice` double(2,2) NOT NULL,
...
--
ALTER TABLE `booking`
  ADD CONSTRAINT `fk_booking_showtime` FOREIGN KEY (`showtimeid`) REFERENCES `showtimes` (`id`),
  ADD CONSTRAINT `fk_booking_user` FOREIGN KEY (`id`) REFERENCES `users` (`id`);
